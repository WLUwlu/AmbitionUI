...
**Methodological frame.** The analysis proceeds inductively from recurring patterns observed across industry accounts, postmortem cultures, and organizational ethnographies, rather than from a single canonical theory. Where useful, it borrows from:

- **Institutional sociology** (DiMaggio & Powell): on-call as a template copied across firms without understanding local conditions.
- **Theory of practice** (Bourdieu): on-call as a field where "ops capital" accumulates and converts into career advantage.
- **Emotional labor** (Hochschild): the unpriced work of staying calm, managing stakeholders, and absorbing anxiety.
- **STS** (Winner, Latour): how alerting tools inscribe accountability into infrastructure, making certain humans "delegated actants" in sociotechnical networks.
...
### Platform tooling and the quantification of suffering (2010s–2020s)

PagerDuty, Opsgenie, VictorOps, and successors did not merely schedule people—they **made on-call legible to management**. Escalation policies, on-call calendars, and incident timelines became audit trails. This quantification had dual effects:

- **Progress:** Leaders could finally see uneven load, duplicate paging, and teams with unsustainable alert volume.
- **Surveillance:** Metrics like MTTR and pages-per-shift became proxies for individual performance, reintroducing blame through the back door of "operational excellence."

The history of on-call tooling is thus also a history of **making private disruption administratively visible**—sometimes to redistribute it, sometimes to justify it.
...
### Organizational typologies and divergent norms

On-call sociology varies sharply by organizational form:

| Org type | Dominant on-call logic | Typical social pathology |
|----------|------------------------|--------------------------|
| Early startup | Everyone is always on-call | Burnout framed as founder grit |
| Growth-stage | Formal rotation emerges late | Original heroes resist giving up pager |
| Big tech / SRE-mature | Error budgets, follow-the-sun | Process theater without staffing |
| Regulated enterprise | Change windows, RACI matrices | Slow response masked as prudence |
| Agency / consultancy | Client SLA drives schedule | Offshore teams absorb temporal cost |
| Open-source maintainer | Volunteer availability | Guilt-driven unpaid labor |

These typologies are not destiny—they show how **business model and liability** shape who sleeps.
...
### Inter-team sociology and the escalation graph

Modern on-call is rarely a single team affair. Escalation policies encode **trust and contempt** between groups: who is tier one, who may wake whom, which team's runbook is authoritative. A poorly maintained escalation graph is a **map of organizational silos**. Pages that bounce between teams during outages produce **accountability hot potato**—each handoff a small abdication of ownership until someone with insufficient context becomes de facto commander.
...
### Primary vs. secondary burden asymmetry

Many policies treat primary and secondary on-call as equivalent participation. In practice, secondaries experience **anticipatory vigilance**—keeping phone charged, avoiding alcohol, maintaining availability—without the catharsis of action. Sociologically, secondary is often **liminal responsibility**: enough obligation to constrain life, insufficient authority to fix systemic issues.

### Reliability investment vs. heroism subsidy

Every dollar not spent on testing, observability, or staffing is a dollar **borrowed from on-call lifetimes**. Organizations face a standing trade-off: fund prevention or subsidize response through human endurance. Hero culture tips the scale toward the latter because heroes are narratively satisfying in ways that boring reliability work is not.
...
### The "non-incident" page at life friction

Not every page is a sev-1 outage. Many are low-severity alerts during dinner, children's bedtime, or medical recovery. The sociology of **death by a thousand benign pages** is under-discussed: cumulative domestic erosion without the narrative closure of a heroic war story.

### Vendor and dependency black holes

When SaaS vendors fail, internal on-call becomes **customer support for someone else's SLA**. The edge case exposes **contractual vs. moral responsibility**—your users blame you; your contract lawyers blame the vendor; the on-call engineer absorbs both angers.

### Rotation during organizational trauma

Layoffs, reorgs, and team dissolutions produce **ghost rotations**: people on-call for services whose authors departed. Knowledge drain turns on-call into **archaeology**—reading tombstone code under pressure.
...
**Structural vs. agential balance.** The analysis emphasizes institutions and incentives; individual agency—choosing to leave, organizing, refusing pages—deserves equal weight. Not all suffering is passive acceptance. Recent labor mobilization in tech, though uneven, shows on-call load entering **negotiated employment terms** in some firms.
...
**AI blind spot.** Emerging AI-assisted triage and autonomous remediation may reduce pages—or may **shift burden** to verifying machine suggestions at odd hours. The sociology of "human in the loop at 3 a.m." is unsettled.
...
- **Audit the escalation graph as org chart truth.** Who can wake whom reveals actual power more honestly than HR diagrams.
...
Until organizations treat that question as seriously as uptime SLAs, rotations will continue to reproduce invisible inequality beneath the guise of shared responsibility. The verbose mandate here is not length for its own sake but **refusal to treat on-call as a solved scheduling problem**—when it remains, at bottom, a problem of justice, visibility, and the distribution of precarity in a world that insists the cloud never sleeps.
