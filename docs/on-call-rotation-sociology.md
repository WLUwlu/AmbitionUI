...
**Methodological note.** This analysis proceeds inductively from recurring patterns observed across industry accounts, organizational ethnographies, and labor sociology. It does not claim universal law-like regularities; rather, it maps **durable tensions** that appear whenever human availability is used as a substitute for system reliability.
...
### Platform engineering and the pager as product (2020s)

The latest phase treats on-call infrastructure itself as a product category: escalation policies, on-call calendars, and incident workflows are commoditized by vendors. This **platformization** can democratize good practices—fair rotations, defined escalation—but also **institutionalizes surveillance**: page counts, mean time to acknowledge, and individual response metrics become performance proxies. History here bends toward **quantified availability**: the pager becomes not only a technical device but a **scoreboard** on which careers are silently evaluated.
...
Modern on-call is rarely a single team affair. Escalation paths encode **organizational politics**: which dependencies are allowed to wake you, which vendors are trusted to self-serve, which teams are considered "tier zero" versus "optional." The escalation graph is a **latent org chart of blame tolerance**. Teams that page upstream early are seen as incompetent; teams that page too late are seen as reckless. Navigating this graph is a social skill not listed in any runbook.
...
**Deep ownership** (one team, full stack) produces responders who can fix end-to-end but pages them for everything. **Shallow ownership** (narrow service boundaries) reduces cognitive load but produces **coordination incidents** where no single on-call can act. The trade-off is between **autonomy** and **coordination tax**—a classic sociological dilemma in division of labor.
...
### The quiet quit of availability

Engineers who formally remain on rotation but **psychologically disengage**—silencing phones, delaying acknowledgment, routing everything to "morning"—represent a passive withdrawal from the social contract. The rotation appears staffed; **actual coverage decays**. This is the on-call analogue of absenteeism, often misdiagnosed as laziness rather than burnout or rational self-protection.

### Vendor and customer paging loops

Third-party monitoring, customer success teams, and executive dashboards can **short-circuit** formal escalation, paging on-call directly for non-technical concerns. The edge case reveals who truly holds organizational power over the pager: often not the team that owns the rotation policy.
...
**Neglect of union and collective action.** Recent labor organizing in tech is reshaping what "mandatory availability" means. This document underweights **collective bargaining** as a force that could redefine on-call as compensated, bounded labor rather than citizenship ritual.
...
Until organizations treat that question as seriously as uptime SLAs, rotations will continue to reproduce invisible inequality beneath the guise of shared responsibility. The pager is not a neutral tool; it is a **weekly referendum** on whose time, health, and domestic life count as expendable infrastructure—and the most honest organizations are those that admit the vote is never truly equal, then work visibly to close the gap.
