...
The pager decoupled alertness from location. Responsibility became **personal and portable**. Home became a annex of the workplace—a process that remote-work sociology later documented at scale, but that began with systems administrators and network operators.
