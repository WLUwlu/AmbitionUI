...
**Methodological note.** This analysis adopts a **sociotechnical systems** lens (Trist and Bamforth, 1951; Orlikowski, 1992): rotations are not "people problems" or "tooling problems" but co-produced arrangements where schedules, escalation policies, monitoring thresholds, and cultural narratives mutually reinforce each other. Changing PagerDuty settings without changing who gets promoted after incidents changes nothing structural.
...
- **Institutional memory.** Hospitals maintain staffing minimums; many tech teams treat headcount as a variable to minimize until pages spike.

The tech industry imported the **watch rotation** metaphor without importing its supporting institutions (compensation frameworks, union protections, trauma support, mandatory rest). Max Weber's analysis of bureaucratic rationality is instructive here: on-call schedules appear as **formal rationality** (fair rotation matrices, SLA math) while operating under **substantive irrationality** (unpaid domestic invasion, unbounded escalation).

### From ops rooms to remote pagers (1970s–1990s)

Early data centers relied on **physical presence**. Operators walked raised floors; the social structure was spatial—you knew who was on the floor by who was in the room. IBM and telecom network operations centers (NOCs) developed **tiered escalation** cultures: Level 1 absorbed noise; Level 3 held real authority. This hierarchy persists in disguised form in modern "L1/L2/L3 support" even when titles changed to SRE.

Pagers democratized alertness: responsibility became **portable**, collapsing the boundary between workplace and home. Motorola pager culture in the 1980s–90s created a new status signal—the beep marked you as **important and replaceable simultaneously**. Unix-era batch jobs and overnight batch failures created the first generation of "the job isn't done when you leave" mentalities among systems staff. The social norm crystallized: **availability equals dedication**.

### Web era and the birth of SRE (2000s)

The consumer internet introduced **24/7 revenue dependency**. Downtime became directly measurable in dollars, which gave finance a vocabulary to demand availability without necessarily funding the humans who provide it. Google's SRE model (Beyer, Jones, Petoff, Murphy, *Site Reliability Engineering*, 2016) formalized error budgets and rotation practices, exporting a **supposedly rational** framework: rotations should be fair, toil should be reduced, blameless postmortems should learningify failure.

Yet exporting the *form* without the *substrate* (staffing ratios, automation investment, cultural safety) led many organizations to adopt **SRE aesthetics**—error budget slides, incident reviews—while retaining **startup sacrifice norms**. The historical irony is sharp: a model designed to *cap* reliability work became, in many adopters, a model to *justify* heroic overwork ("we're still within budget").
...
Remote work further blurred boundaries. When home is office, on-call is not an intrusion into domestic life; it is a **toggleable layer always humming beneath awareness**. The always-on Slack culture parallel to formal rotations creates a **shadow on-call**: people who are not scheduled still feel obligated to respond. Platform engineering and internal developer platforms promised to "pave roads" and reduce pages; in practice they often **centralized expertise** while **distributing pager ownership** to product teams less prepared for ops sociology.

### Historical through-line

Across decades, the constant is **asymmetric visibility**: organizations see uptime; individuals feel insomnia. What changed is scale, speed, and the **myth of automation**—each wave promised fewer pages, yet organizational complexity often outpaced tooling, recreating demand for human absorbers. The pager survived every generation of tooling because **someone must decide** when automated rollback is insufficient, when customer communication requires human judgment, and when organizational politics demands a scapegoat or a hero.
...
Institutions persist when they solve coordination problems. On-call solves: *Who do we disturb when something breaks?* It creates predictability for the organization at potential cost to the individual. Émile Durkheim would recognize the rotation as a **mechanical solidarity** mechanism in small teams (everyone takes turns) evolving toward **organic solidarity** in large orgs (specialist carriers of pager debt).
...
Conversely, teams that rotate broadly accumulate **distributed resilience**; teams that concentrate on-call in a specialist caste create **single points of human failure** dressed as efficiency. Michel Foucault's notion of **disciplinary power** applies uncomfortably well: the pager internalizes surveillance—engineers self-monitor, pre-check dashboards before dinner, and curtail plans because **the possibility of being summoned** reshapes behavior even when no page arrives.
...
Coverage swaps are **informal currency**. Declining without reciprocity violates solidarity; always accepting creates exploitation. Teams with weak psychological safety handle swaps opaquely; strong teams treat coverage as **visible, counted labor**. Marcel Mauss's *The Gift* (1925) illuminates swap dynamics: coverage appears "free" but creates **implicit debt** that may never be repaid equitably.

### Identity, masculinity, and hero narratives

Ops culture historically celebrated **stoic endurance**: sleep deprivation as proof of commitment. Hero narratives serve organizational interests—they normalize unpaid or underpaid surplus labor as passion. Sociologists of gender note parallels to **invisible care work** (Hochschild, 1983): the emotional labor of staying calm, reassuring stakeholders, and protecting teammates from blame often falls on whoever is on-call, frequently without acknowledgment.

The **blameless postmortem** is an institutional attempt to counter hero/blame cycles. Its success depends not on document templates but on **whether power actually refrains from punishment** when postmortems reveal uncomfortable truths. Where postmortems work, they function as **rituals of collective learning** akin to medical morbidity and mortality conferences—where they fail, they become **theater of accountability**.
...
- Contractors and vendors excluded from rotation but expected to answer "just this once."

When exclusion is unexamined, teams become **demographically skewed toward those who can afford availability**, reproducing inequality under the banner of meritocracy. Intersectionality matters: the person covering APAC nights from headquarters may face both temporal and geographic marginalization.

### Communication rituals

Incidents generate **temporary communities** with roles (commander, scribe, comms lead). These rituals resemble **emergency response drills**: shared language, checklists, performative calm. They build cohesion but can also **perform competence** while masking structural deficits—excellent incident response compensating for poor incident prevention. Erving Goffman's **frame analysis** helps: the incident channel is a **stage** where participants perform the role of "competent responder," sometimes at the expense of admitting uncertainty.
...
| Design | Social benefit | Social cost |
|--------|----------------|-------------|
| Equal rotation | Shared empathy, broad skill exposure | Slower incident resolution, anxiety for juniors |
| Expert-heavy rotation | Faster mitigation, fewer mistakes | Burnout concentration, caste formation |
| No rotation (outsourced NOC) | Feature team sleep | Context loss, us-vs-them dynamics |
...
Lowering alert thresholds improves detection but increases **noise pages**, training people to ignore or mute—**normalization of deviance** (Diane Vaughan, *The Challenger Launch Decision*). Raising thresholds reduces fatigue but risks slow detection. The trade-off is technical on the surface; socially it is about **what counts as urgent** and who gets to decide.

### Compensation vs. citizenship framing

Some orgs pay on-call stipends or incident bonuses; others frame rotation as **professional citizenship**—part of the job. Paying acknowledges pain as labor; citizenship framing encourages **moral blackmail** ("team player") and hides costs in unpaid life hours. Partial compensation (token stipend far below hourly value) may be worse than none—it signals acknowledgment without fair exchange.
...
### Rotation length and calendar politics

Short rotations (24–48 hours) minimize individual exposure but increase **handoff frequency**—errors at boundaries. Long rotations (weekly) deepen context but amplify burnout and domestic disruption. **Calendar politics**—who sets rotation start day, whether Monday handoffs cluster with release trains—reveals whose convenience the institution serves.
...
### Merger and acquisition rotation chaos

Post-acquisition, duplicate monitoring stacks, overlapping rotations, and unclear service ownership produce **pager anarchy**. Socially, acquired teams often inherit **worse** rotation terms as "integration cost."

### The "optional" executive escalation

When leadership insists on being in the loop but not in the rotation, on-call bears **upward management labor** during incidents without reciprocal overnight burden—a microcosm of organizational hierarchy.

### AI-assisted triage and new asymmetries

LLM-based incident summarization and auto-triage introduce fresh edge cases: who validates model suggestions at 4 a.m., and who is liable when AI mis-prioritizes? The sociology preview: **accountability sinks to human on-call** while credit accrues to automation narratives.
...
**Structural vs. agential balance.** The analysis emphasizes institutions and incentives; individual agency—choosing to leave, organizing, refusing pages—deserves equal weight. Not all suffering is passive acceptance; labor organizing in tech, though nascent, is reshaping on-call expectations in some firms.
...
**Theoretical eclecticism.** Durkheim, Foucault, Mauss, Goffman, and Vaughan appear as illustrative lenses, not as a unified theory. A single-framework analysis might be sharper but less accessible.
...
- **Audit informal exemptions.** Who has actually stopped rotating, and is that fair or a hidden perk?

**Comparative insight.** Organizations with lower on-call trauma tend to share traits less about tooling than sociology: **executives who have recently rotated**, **staffing ratios that treat pages as signals to hire**, and **post-incident budgets for remediation rather than only review**.
...
Until organizations treat that question as seriously as uptime SLAs, rotations will continue to reproduce invisible inequality beneath the guise of shared responsibility. The pager will keep ringing—not because the technology requires it, but because the social contract has not yet been renegotiated.
