...
- Do not page the tech lead unless the building is on fire (unless the building *is* on fire, in which case page everyone).
- The person who wrote the deploy is morally implicated even if they are not on-call.
- Acknowledging a page within five minutes is performance; fixing the problem is substance.

**Rituals** surround the institution: handoff notes, pre-shift anxiety checks, post-incident retrospectives, and the informal debrief over coffee where the real story is told. These rituals stabilize the system by converting chaotic events into narratable episodes—but they also reproduce hierarchy. Who speaks first in the retro? Whose timeline becomes canonical? Whose fatigue is treated as data versus drama?
...
In many teams, having survived brutal on-call seasons confers **informal seniority**. The pager becomes a credential: "I've carried the load." Conversely, engineers who opt out of rotation—through specialization, management track, or negotiated exemption—may be seen as having exited the moral community of builders, even when their work remains essential.

This produces a **status economy** where availability is traded for respect. The engineer who answers at 3 a.m. gains narrative capital in postmortems and architecture debates; the engineer who improves observability to prevent 3 a.m. pages may receive less visible recognition because prevention lacks drama.
