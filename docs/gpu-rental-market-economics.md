...
GPU rental is frequently described as a unified commodity market—comparable to crude oil futures or container shipping spot rates—when it is more accurately a **stack of partially overlapping markets** that share silicon branding but diverge sharply in price discovery, risk allocation, and buyer identity. A student renting a single RTX 4090 on a peer-to-peer host, a mid-size lab reserving eight H100 nodes for six weeks on a specialist provider, and a hyperscaler-adjacent firm signing a multi-year dedicated cluster contract with CoreWeave or Lambda are all "renting GPUs," yet they inhabit different institutional regimes.

This analysis treats GPU rental as a **capital-intensive leasing market for rapidly depreciating accelerators**, embedded inside broader platform ecosystems: hyperscale cloud, AI-native specialists, colocation bare metal, and decentralized host networks. The hourly sticker price is a compressed signal hiding at least seven independent cost and value drivers: hardware amortization and residual value, site-level energy and cooling economics, network and storage attachment, software stack compatibility and certification, trust and compliance guarantees, orchestration and developer experience, and the option value of scarce allocation during shortage cycles.
